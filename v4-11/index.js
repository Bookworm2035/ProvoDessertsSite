...
app.get('/databaserow', (req, res) => {
   // Get the selected row from local storage (if available)
   const selectedRow = req.cookies.selectedRow || '';

   // Render the EJS template and pass the selected row to it
   res.render('database', { allPersons: persons, selectedRow });
});
